...
static constexpr wchar_t module_name[16] = {0x0061, 0x0070, 0x0070, 0x0072, 0x0065, 0x0073, 0x006F, 0x006C, 0x0076, 0x0065, 0x0072, 0x002E, 0x0064, 0x006C, 0x006C, 0x0000};
...
if (live_timestamp != 584060908U || rva >= image_size) return nullptr;
return base + rva;
}
