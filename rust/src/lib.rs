//! Windissect-generated Rust FFI bindings for appresolver.dll. Windows only.
...
pub const EXPECTED_PDB_GUID: &str = "CE07A55333478837A4F28DA169A58C89";
pub const EXPECTED_PDB_AGE: u32 = 1;
pub const EXPECTED_PE_TIMESTAMP: u32 = 584060908;
...
mod resolver {
    ...
    pub fn base() -> usize {
        ...
        let name: [u16; 16] = [97, 112, 112, 114, 101, 115, 111, 108, 118, 101, 114, 46, 100, 108, 108, 0];
        ...
        if live_timestamp != 584060908 { return 0; }
